...
# stone_checksums Rakefile v7.1.13 - 2026-08-31
...
# rake install                                # Build and install stone_checksums-1.0.0.gem in...
# rake install:local                          # Build and install stone_checksums-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template stone_checksums against itse...
